...
export function CtaPanel({ heading, body, buttonLabel = site.bookingLabel, className }: CtaPanelProps) {
  return (
    <section
      className={cn(
        "relative overflow-hidden rounded-lg border border-accent-300/25 bg-[linear-gradient(135deg,#132333_0%,#0B1622_55%,#09131D_100%)] p-7 shadow-[0_28px_90px_rgba(0,0,0,0.36)] sm:p-9 lg:p-12",
        className,
      )}
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_88%_0%,rgba(45,212,191,0.16),transparent_20rem)]" aria-hidden="true" />
