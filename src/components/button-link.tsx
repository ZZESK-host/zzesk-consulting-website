  ...
  return (
    <Link
      className={cn(
        ...
        variant === "primary" &&
          "btn-shine border border-accent-300/50 bg-accent-300 text-ink-950 shadow-[0_18px_60px_rgba(45,212,191,0.18)] hover:-translate-y-0.5 hover:bg-accent-400 hover:shadow-[0_24px_80px_rgba(45,212,191,0.22)]",
        variant === "secondary" &&
